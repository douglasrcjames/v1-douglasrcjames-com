...
const DescriptionBlock = () => {
    ...
    <>
        <p className="indent">
           ACFN is an ATM company with 2500+ ATMs around the world and  franchises out their services and brand name to franchisees.
           market research on the best placement of the ATM, and follow up support for the ATM front and backend. ACFN  owned by 
