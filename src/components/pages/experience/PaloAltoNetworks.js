...
const DescriptionBlock = () => {
    ...
    <>
        <p className="indent">
            ...
            who was an MIS student and recent employee at Palo Alto Networks at the time. Palo AAfter discussion on my interest in all things technology, he advised that I send him my 
            resume to forward to his hiring manager to work with him there. After a few phone interviews, and one in person interview, I got the job! The job fit me perfectly, 
            ...
            of separate spreadsheets and cross reference them into one consolidated list to reference. I was able to finish the project, but it was boring and more difficult than my manager or 
            I had anticipated because many assets were either unaccounted for or unaccessible.  Through this, I learned the bureaucracy of a large, publicly traded corporation, 
            especially because it was a network security firm. Ultimately, I loved this job, and grateful for the lessons I learned throughout... especially grateful for the 
            amenities provided, like free snacks, Great America theme park pass, and more!
